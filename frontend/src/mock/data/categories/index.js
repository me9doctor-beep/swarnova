...
export const categories = [
  {
    ...
    cta: { label: "Explore Rings", href: "/category/rings" },
    enabled: true,
    order: 1,
  },
  {
    ...
    cta: { label: "Explore Necklaces", href: "/category/necklaces" },
    enabled: true,
    order: 2,
  },
  {
    ...
    cta: { label: "Explore Earrings", href: "/category/earrings" },
    enabled: true,
    order: 3,
  },
  {
    ...
    cta: { label: "Explore Bracelets", href: "/category/bracelets" },
    enabled: true,
    order: 4,
  },
];
